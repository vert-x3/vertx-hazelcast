...
For example, you might want to change the cluster group name:
...
<replicatedmap name="__vertx.subs">
...
<replicatedmap name="__vertx.nodeInfo">
  <merge-policy>PutIfAbsentMergePolicy</merge-policy>
</replicatedmap>
...
{@link io.vertx.core.eventbus.EventBusOptions#setHost}.
