...
If you are using Vert.x from the command line, the jar corresponding to this cluster manager (it will be named `vertx-hazelcast-3.5.2.CR1.jar`
...
the artifact: `io.vertx:vertx-hazelcast:3.5.2.CR1` in your project.
...
----
dependencies {
 compile ("io.vertx:vertx-hazelcast:3.5.2.CR1"){
