...
If you are using Vert.x from the command line, the jar corresponding to this cluster manager (it will be named `vertx-hazelcast-3.4.1.jar`
...
the artifact: `io.vertx:vertx-hazelcast:3.4.1` in your project.
